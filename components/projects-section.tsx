...
const projects = [
  ...
  {
    title: "WSL — Adult Learner Certification Toolkit",
    description:
      "Designed a data-driven marketing toolkit and certification roadmap for Washington State Library to help adult learners access workforce certifications.",
    tools: ["Figma", "Accessibility", "Market Research", "Design Systems"],
